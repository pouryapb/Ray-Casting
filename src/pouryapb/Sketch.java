...
public class Sketch extends JFrame {
	...
	private Particle particle = new Particle(200, 100, new Vector(0, -1));
...
//				float theta = (float) Math.toDegrees(Math.atan2(particle.dir.y, particle.dir.x));
//				theta -= e.getWheelRotation() * 10;
//				
//				particle.updateDir(Vector.VectorFromAngle(Math.toRadians(theta)));
//				repaint();
//			}
//		});
...
//				int c = e.getKeyCode();
//				
//				int movementSpeed = 2, rotationSpeed = 2;
//				
//				if (c == KeyEvent.VK_UP) {
//					particle.pos.x += particle.dir.x * movementSpeed;
//					particle.pos.y += particle.dir.y * movementSpeed;
//				}
...
//					double theta = Math.atan2(particle.dir.y, particle.dir.x);
//					theta -= Math.toRadians(rotationSpeed);
//					
//					particle.updateDir(new Vector((float)Math.cos(theta), (float)Math.sin(theta)));
//				}
